...
<Head>
  ...
  <meta property="og:title" content="Spring Boot - Cloudinator" />
  ...
  <meta name="twitter:title" content="Spring Boot - Cloudinator" />
...
##### <span className="text-gray-500 font-semibold">Microservices Support</span>
...
##### <span className="text-gray-500 font-semibold">Production Ready</span>
...
##### <span className="text-gray-500 font-semibold">Dependency Management</span>
...
##### <span className="text-gray-500 font-semibold">DevTools for Faster Development</span>
...
##### <span className="text-gray-500 font-semibold">Integration with Spring Ecosystem</span>
