...
const ScrollProgressBar = () => {
    ...
    return (
        <>
            ...
            <motion.button
                onClick={scrollToTop}
                className="fixed bottom-8 right-6 w-10 h-10 p-2 rounded-full bg-purple-500 text-white shadow-lg hover:bg-purple-600 transition-colors duration-300 z-50"
